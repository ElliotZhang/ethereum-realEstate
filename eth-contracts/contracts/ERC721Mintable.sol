...
contract ERC721 is ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        require(owner != address(0), "Invalid account to check balance");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        string memory url = strConcat(_baseTokenURI, tokenString);
...
contract ERC721Mintable is ERC721Metadata {
    ...
    function mint(address _to, uint256 _tokenId, string memory /* _tokenURI */) public onlyOwner() returns(bool) {
        ERC721Enumerable._mint(_to, _tokenId);
